...
It assumes you have already completed [Build and Install](integration-guide.md#step-1-build-and-install)
and the [thread configurator setup](integration-guide.md#step-3-set-up-the-thread-configurator) (granting
capabilities and configuring library paths).
